...
class DistanceSensor: public Thread
{
    ...
    protected:
      ...
      Gpio<TGPIOC, 4, GPIO_MODE_AN> sensor_in_0; //front as ADC input, ADC8
      Gpio<TGPIOB, 0, GPIO_MODE_AN> sensor_in_1; //left as ADC input, ADC10
      Gpio<TGPIOC, 5, GPIO_MODE_AN> sensor_in_2; //right as ADC input, ADC9
