...
class Timer
{
  ...
  public:
    ...
    int add_task(void (*callback_function)(), unsigned int period_ms, bool main_loop_callback_enabled);

    int add_task(class Thread *callback_class, unsigned int period_ms, bool main_loop_callback_enabled);
    ...
    unsigned long int get_time_interrupt();
